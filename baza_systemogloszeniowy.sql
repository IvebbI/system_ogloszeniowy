...
--
-- Host: 127.0.0.1
-- Generation Time: Paź 31, 2023 at 06:32 PM
...
CREATE TABLE `ogloszenie` (
  ...
  `widełki_wynagrodzenia` varchar(100) DEFAULT NULL,
...
INSERT INTO `ogloszenie` (`id`, `id_firmy`, `nazwa`, `poziom_stanowiska`, `rodzaj_umowy`, `wymiar_etatu`, `rodzaj_pracy`, `widełki_wynagrodzenia`, `dni_pracy`, `godziny_pracy`, `data_waznosci`, `kategoria`, `zakres_obowiazkow`, `wymagania_kandydata`, `oferowane_benefity`, `informacje_o_firmie`) VALUES
